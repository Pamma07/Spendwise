      ...
      <div className="stats-con">
        ...
        <div className="history-con">
          ...
          <div className="salary-item transition-transform transform hover:scale-105">
            <p className="transition-transform transform hover:scale-105">INR.{Math.min(...incomes.map((item) => item.amount))}</p>
            <p className="transition-transform transform hover:scale-105">INR.{Math.max(...incomes.map((item) => item.amount))}</p>
          </div>
          <h2 className="salary-title">
            Min <span>Expense</span>Max
          </h2>
          <div className="salary-item transition-transform transform hover:scale-105">
            <p className="transition-transform transform hover:scale-105">INR.{Math.min(...expenses.map((item) => item.amount))}</p>
            <p className="transition-transform transform hover:scale-105">INR.{Math.max(...expenses.map((item) => item.amount))}</p>
          </div>
        </div>
      </div>
    </InnerLayout>
